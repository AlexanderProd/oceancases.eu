  ...
  <Page title="Über uns">
    <Wrapper>
      ...
      <p>
        ...
        Weiterverarbeitung von Plastik sehr umweltschädlich. Das benötigte Erdöl
        und andere Chemikalien sind sehr schlecht für die Umwelt. Selbst wenn
        nach der Nutzung von Plastik, dieser nicht im Meer landet, so werden 55%
        verbrannt. Auch hierbei entstehen giftige Stoffe wie Chlor und Dioxine,
        welche negative Folgen für alle Lebewesen mit sich bringen. So sind wir
        als Generation in der Pflicht Etwas zu ändern. Für die Tiere. Für die
        Menschen. Und für die Welt.
        <br />
        <br />
        ...
        recycelbar. Zudem spenden wir pro verkauftem Case 1€ an die Organisation
        „the ocean clean up“. Diese setzt sich für die Reinigung der
        verschmutzten Meeres Gebiete ein. Um den Planeten nicht nur zu schützen,
        sondern auch zu reparieren.
        <br />
        <br />
      </p>
    </Wrapper>
